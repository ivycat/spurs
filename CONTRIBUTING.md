# Contributing to the Spurs Project

First, make sure to check out and consider contributing to [Understrap](https://understrap.com) and [Sage](https://roots.io/sage/), two inspirations and code sources for Spurs.
...
## Report bugs using Github's [issues](https://github.com/sewmyheadon/spurs/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/sewmyheadon/spurs/issues/new) - it's that easy!
