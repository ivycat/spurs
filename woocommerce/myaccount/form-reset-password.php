...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
    ...
    <p class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
        <label for="password_1"><?php esc_html_e( 'New password', 'spurs' ); ?>&nbsp;<span
    ...
    <p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
        <label for="password_2"><?php esc_html_e( 'Re-enter new password', 'spurs' ); ?>&nbsp;<span
                    class="required">*</span></label>
        <input type="password" class="woocommerce-Input woocommerce-Input--text input-text form-control"
    ...
    <p class="woocommerce-form-row form-row">
        ...
        <button type="submit" class="btn btn-outline-primary"
                value="<?php esc_attr_e( 'Save', 'spurs' ); ?>"><?php esc_html_e( 'Save', 'spurs' ); ?></button>
    </p>
