...
<?php endif; ?>
	...
	<form class="woocommerce-form woocommerce-form-login login" method="post">
		...
		<p class="form-row">
			...
			<button type="submit" class="btn btn-outline-primary" name="login" value="<?php esc_attr_e( 'Log in', 'spurs' ); ?>"><?php esc_html_e( 'Log in', 'spurs' ); ?></button>
	...
	<div class="u-column2 columns-6">
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="btn btn-outline-primary" name="register" value="<?php esc_attr_e( 'Register', 'spurs' ); ?>"><?php esc_html_e( 'Register', 'spurs' ); ?></button>
			</p>
