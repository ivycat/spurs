...
$my_orders_columns = apply_filters( 'woocommerce_my_account_my_orders_columns', array(
	'order-number'  => __( 'Order', 'spurs' ),
	'order-date'    => __( 'Date', 'spurs' ),
	'order-status'  => __( 'Status', 'spurs' ),
	'order-total'   => __( 'Total', 'spurs' ),
	'order-actions' => '&nbsp;',
) );
					...
					<?php foreach ( $my_orders_columns as $column_id => $column_name ) : ?>
						<td class="<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
							...
							<?php elseif ( 'order-total' === $column_id ) : ?>
								<?php echo sprintf( _n( '%s for %s item', '%s for %s items', $item_count, 'spurs' ), $order->get_formatted_order_total(), $item_count ); ?>
