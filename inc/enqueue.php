...
if ( ! function_exists( 'spurs_scripts' ) ) {
	...
	function spurs_scripts() {
		...
		$css_version = $theme_version . '.' . filemtime( get_template_directory() . '/dist/css/fontawesome.min.css' );
		wp_enqueue_style( 'fontawesome-styles', get_stylesheet_directory_uri() . '/dist/css/fontawesome.min.css', array(), $css_version );

		$css_version = $theme_version . '.' . filemtime( get_template_directory() . '/dist/css/theme.min.css' );
		wp_enqueue_style( 'spurs-styles', get_stylesheet_directory_uri() . '/dist/css/theme.min.css', array(), $css_version );
		...
		wp_enqueue_script( 'spurs-scripts', get_template_directory_uri() . '/dist/js/theme.min.js', array(), $js_version, true );
