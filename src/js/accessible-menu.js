		...
		switch (e.key) {
			case "ArrowDown": // down key
				...
				if (
					...
					!$(this).next("ul.dropdown-menu.dropdown-submenu")
				) {
			...
			case "ArrowLeft": // left key
				...
				if (
					...
					if ($(this).parent("li.menu-item:first-child").length > 0) {
						...
						$(this)
							.closest("ul.dropdown-menu.dropdown-submenu.show")
							.removeClass("show");
			...
			case "Enter": // Enter Key
				...
				if (
					$(this).closest("ul.navbar-nav").length > 0 &&
					$(this).closest("ul.dropdown-menu").length == 0
				) {
