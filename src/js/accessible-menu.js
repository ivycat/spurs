...
(function($) {
    ...
    var dropdownToggle   = $('<button />', {'class': 'dropdown-toggle','aria-expanded': false, 'role': 'button'})
    .append($('<div />', {'class': 'chevron-right'}))
    .append($('<span />', {'class': 'screen-reader-text sr-only screen-readers',text: screenReaderText.expand}));
